		...
		<div class="container-fluid">
				...
				<div class="col-sm-12">
					...
					<div class="header">
						...
						<div class="menu text-center">
							...
							<ul>
								<li class="selected">Resto</li>
								<a href="trains.php"><li>Trains</li></a>
								<a href="hotels.php"><li>Hotel</li></a>
							</ul>
			...
			<!-- HOTELS SEARCH SECTION STARTS -->
				...
				<div class="col-sm-12">
					...
					<div class="search" id="searchResto">
    					...
    					<form action="hotelSearch.php" method="GET">
   							...
   							<div class="form-group">
   								 <label for="city">City:<p> </p></label>
      								...
      								<select id= "city"  data-live-search="true" class="selectpicker form-control" data-size="5" title="Select City" name="city" required>
       									<option value="Pangasinan" data-tokens="Mang inasal">Mang inasal</option>
        								<option value="Pangasinan" data-tokens="KFC">KFC</option>
        								<option value="Pangasinan" data-tokens="Jollibee">Jollibee</option>
        								<option value="Pangasinan" data-tokens="MCDO">MCDO</option>
        								<option value="Pangasinan" data-tokens="Unli wings">Wings to fry</option>
            				...
            				<div class="col-sm-3">
        						<div class="form-group">
     								<label for="datetime5">Book in:<p> </p></label>
    						...
    						<div class="col-sm-3">
        						<div class="form-group">
     								<label for="datetime6">Cancel:<p> </p></label>
							...
							<label for="rooms">No. of people:<p> </p></label>
    							<div class="form-group">
    								<select id= "rooms" class="selectpicker form-control" data-size="10" title="Select no. of people" name="table" required>
